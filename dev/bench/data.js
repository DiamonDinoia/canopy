    ...
    "treeweave batch eval": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "3dba58456acf1acc126d597580c5d307b939bb1c",
          "message": "Benchmark showcase (zeta) + JS/TS binding + version API\n\nReplace the cross-language benchmark's lgamma target with a dependency-free\nRiemann-zeta partial sum zeta_N(s) = sum_{k=1..N} k^-s (N=1e6) fit on [2, 10]:\na genuinely expensive function (N pow()s per eval), so a fitted polynomial eval\nbeats recomputing the sum decisively in every mode — including scalar. zeta is\nnow the quick-start example in all seven languages. lgamma and its bench-only\ndeps (scipy, pyyaml, SpecialFunctions, @stdlib/gammaln) are removed.\n\n- Charts: horizontal grouped Mevals/s bars (treeweave vs native, log x,\n  languages on y); bars are labelled with the within-language speedup (native =\n  1x baseline, treeweave = Nx) and the throughput chart marks the 1 Meval/s\n  line. README embeds the three throughput charts (single/multi/sorted); the\n  perf guide adds latency + sorted-vs-unsorted.\n- JS/TS binding (bindings/js): N-API addon + WASM, TS layer, node:test suite\n  (9/9), zeta example. CMake TREEWEAVE_BUILD_JS + bindings-js / bindings-js-wasm\n  presets; bindings.yml gains a `js` job (native + WASM).\n- Version API (poet-style): <treeweave_version.h> is generated from\n  include/treeweave_version.h.in + the tracked VERSION file (single source of\n  truth) by cmake/treeweave_generate_version.cmake, and committed in the\n  include/ tree so every build path that adds include/ finds it (no separate\n  generated-include dir to propagate) — regenerated at configure and guarded by\n  a pre-commit hook. Runtime treeweave_version()/_string(), C++\n  treeweave::version_*, TREEWEAVE_VERSION_AT_LEAST + TREEWEAVE_VERSION_FULL.\n- benchmark-showcase.yml: zeta benches, fixed julia/octave legs, `js` leg.\n- GitHub Actions referenced by tag, not commit SHA.\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-06-15T14:16:02-04:00",
          "tree_id": "af283b840632c7af7a6a3fe5fb5e23f6e626f768",
          "url": "https://github.com/DiamonDinoia/treeweave/commit/3dba58456acf1acc126d597580c5d307b939bb1c"
        },
        "date": 1781547521916,
        "tool": "customSmallerIsBetter",
        "benches": [
          {
            "name": "eval/1d/runge/f64",
            "value": 0.000518948375,
            "unit": "s/batch",
            "extra": "MdAPE=0.00261332868366673; batch=65536 pts/call"
          },
          {
            "name": "eval/2d/bump/f64",
            "value": 0.00111204322222222,
            "unit": "s/batch",
            "extra": "MdAPE=0.00713135599914718; batch=65536 pts/call"
          },
          {
            "name": "eval/3d/smooth/f64",
            "value": 0.00173515911111111,
            "unit": "s/batch",
            "extra": "MdAPE=0.00339310454898566; batch=65536 pts/call"
          },
          {
            "name": "eval/2d->3d/vector/f64",
            "value": 0.000890997,
            "unit": "s/batch",
            "extra": "MdAPE=0.00535110867946027; batch=65536 pts/call"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "7d4ca71651c8d1893d78388f6ebfbf9e3a1e7153",
          "message": "Benchmark showcase (zeta) + JS/TS binding + version API\n\nReplace the cross-language benchmark's lgamma target with a dependency-free\nRiemann-zeta partial sum zeta_N(s) = sum_{k=1..N} k^-s (N=1e6) fit on [2, 10]:\na genuinely expensive function (N pow()s per eval), so a fitted polynomial eval\nbeats recomputing the sum decisively in every mode — including scalar. zeta is\nnow the quick-start example in all seven languages. lgamma and its bench-only\ndeps (scipy, pyyaml, SpecialFunctions, @stdlib/gammaln) are removed.\n\n- Charts: horizontal grouped Mevals/s bars (treeweave vs native, log x,\n  languages on y); bars are labelled with the within-language speedup (native =\n  1x baseline, treeweave = Nx) and the throughput chart marks the 1 Meval/s\n  line. README embeds the three throughput charts (single/multi/sorted); the\n  perf guide adds latency + sorted-vs-unsorted.\n- JS/TS binding (bindings/js): N-API addon + WASM, TS layer, node:test suite\n  (9/9), zeta example. CMake TREEWEAVE_BUILD_JS + bindings-js / bindings-js-wasm\n  presets; bindings.yml gains a `js` job (native + WASM).\n- Version API (poet-style): <treeweave_version.h> is generated from\n  include/treeweave_version.h.in + the tracked VERSION file (single source of\n  truth) by cmake/treeweave_generate_version.cmake, and committed in the\n  include/ tree so every build path that adds include/ finds it (no separate\n  generated-include dir to propagate) — regenerated at configure and guarded by\n  a pre-commit hook. Runtime treeweave_version()/_string(), C++\n  treeweave::version_*, TREEWEAVE_VERSION_AT_LEAST + TREEWEAVE_VERSION_FULL.\n- benchmark-showcase.yml: zeta benches, fixed julia/octave legs, `js` leg.\n- GitHub Actions referenced by tag, not commit SHA.\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-06-15T14:32:09-04:00",
          "tree_id": "821acf500e1cabcba2aa72fd7d3ce6f6720f4508",
          "url": "https://github.com/DiamonDinoia/treeweave/commit/7d4ca71651c8d1893d78388f6ebfbf9e3a1e7153"
        },
        "date": 1781548393905,
        "tool": "customSmallerIsBetter",
        "benches": [
          {
            ...
            "value": 0.00052175425,
            "unit": "s/batch",
            "extra": "MdAPE=0.00245934903809946; batch=65536 pts/call"
          },
          {
            "name": "eval/2d/bump/f64",
            "value": 0.000945255888888889,
            "unit": "s/batch",
            "extra": "MdAPE=0.00776289701920749; batch=65536 pts/call"
          },
          {
            "name": "eval/3d/smooth/f64",
            "value": 0.00176293966666667,
            "unit": "s/batch",
            "extra": "MdAPE=0.00061444127856183; batch=65536 pts/call"
          },
          {
            "name": "eval/2d->3d/vector/f64",
            "value": 0.00090061325,
            "unit": "s/batch",
            "extra": "MdAPE=0.00160645282389823; batch=65536 pts/call"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "efe889e8a4d592ee89429bf30b069ed1c8077d1e",
          "message": "Benchmark showcase (zeta) + JS/TS binding + version API\n\nReplace the cross-language benchmark's lgamma target with a dependency-free\nRiemann-zeta partial sum zeta_N(s) = sum_{k=1..N} k^-s (N=1e6) fit on [2, 10]:\na genuinely expensive function (N pow()s per eval), so a fitted polynomial eval\nbeats recomputing the sum decisively in every mode — including scalar. zeta is\nnow the quick-start example in all seven languages. lgamma and its bench-only\ndeps (scipy, pyyaml, SpecialFunctions, @stdlib/gammaln) are removed.\n\n- Charts: horizontal grouped Mevals/s bars (treeweave vs native, log x,\n  languages on y); bars are labelled with the within-language speedup (native =\n  1x baseline, treeweave = Nx) and the throughput chart marks the 1 Meval/s\n  line. README embeds the three throughput charts (single/multi/sorted); the\n  perf guide adds latency + sorted-vs-unsorted.\n- JS/TS binding (bindings/js): N-API addon + WASM, TS layer, node:test suite\n  (9/9), zeta example. CMake TREEWEAVE_BUILD_JS + bindings-js / bindings-js-wasm\n  presets; bindings.yml gains a `js` job (native + WASM).\n- Version API (poet-style): <treeweave_version.h> is generated from\n  include/treeweave_version.h.in + the tracked VERSION file (single source of\n  truth) by cmake/treeweave_generate_version.cmake, and committed in the\n  include/ tree so every build path that adds include/ finds it (no separate\n  generated-include dir to propagate) — regenerated at configure and guarded by\n  a pre-commit hook. Runtime treeweave_version()/_string(), C++\n  treeweave::version_*, TREEWEAVE_VERSION_AT_LEAST + TREEWEAVE_VERSION_FULL.\n- benchmark-showcase.yml: zeta benches, fixed julia/octave legs, `js` leg.\n- GitHub Actions referenced by tag, not commit SHA.\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-06-15T14:37:40-04:00",
          "tree_id": "8a7653c19906bda0b430bf0cf34478e74259531f",
          "url": "https://github.com/DiamonDinoia/treeweave/commit/efe889e8a4d592ee89429bf30b069ed1c8077d1e"
        },
        "date": 1781548824785,
        "tool": "customSmallerIsBetter",
        "benches": [
          {
            ...
            "value": 0.0006977999,
            "unit": "s/batch",
            "extra": "MdAPE=0.0137110857165471; batch=65536 pts/call"
          },
          {
            "name": "eval/2d/bump/f64",
            "value": 0.00122209133333333,
            "unit": "s/batch",
            "extra": "MdAPE=0.0170562887210525; batch=65536 pts/call"
          },
          {
            "name": "eval/3d/smooth/f64",
            "value": 0.0021773705,
            "unit": "s/batch",
            "extra": "MdAPE=0.00326475955422115; batch=65536 pts/call"
          },
          {
            "name": "eval/2d->3d/vector/f64",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "2069f00302b571021062ce8b33c219032c18f335",
          "message": "Pre-release polish: clean release version, per-language CI, README badges\n\nPrepare the treeweave 0.0.0 release.\n\n- Version: add TREEWEAVE_RELEASE_VERSION override to\n  treeweave_generate_version.cmake so release builds bake a clean \"0.0.0\" into\n  shipped C/C++ headers despite being built before the tag; the C-ABI build\n  passes it. Everyday dev builds keep -dev.N.\n- Benches: name the fitted object `fn` consistently across the Python, Julia,\n  JS, MATLAB, and Fortran zeta benches.\n- Examples/docs: use the Riemann-zeta function (not Runge) as the illustrative\n  fit example in docs/index.rst, docs/guides/cpp.rst, and examples/c++/simple1d.cpp,\n  matching the benchmark story; the snippets are self-contained (include <cmath>,\n  define zeta) so they compile and run on copy-paste. The Runge-phenomenon prose\n  in how-treeweave-works.md and the internal perf benchmarks are unchanged.\n- Docs: document the mwrap single-point eval overhead as a known limitation\n  (docs/known-issues.md, linked from performance.rst; mirrored in the MATLAB\n  binding README).\n- CI: split bindings.yml into per-language workflows (python/julia/fortran/\n  octave/js/matlab.yml) so each binding earns its own status badge; release.yml\n  preflight now gates on the per-language set (matlab best-effort, not gated).\n- README: FINUFFT-style badge row (core + per-binding) and a Supported bindings\n  table with status badges + example links.\n- Post-release: add release-install.yml validating pip-from-PyPI and the C-ABI\n  tarball find_package path from a published release.\n- Accuracy: CHANGELOG and docs/index.rst now list the JS/TS wrapper.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-15T15:26:38-04:00",
          "tree_id": "e27cf0523fb55998d177fb0d26b16136c15f8fca",
          "url": "https://github.com/DiamonDinoia/treeweave/commit/2069f00302b571021062ce8b33c219032c18f335"
        },
        "date": 1781551688939,
        "tool": "customSmallerIsBetter",
        "benches": [
          {
            "name": "eval/1d/runge/f64",
            "value": 0.000672713444444444,
            "unit": "s/batch",
            "extra": "MdAPE=0.00453625506295602; batch=65536 pts/call"
          },
          {
            "name": "eval/2d/bump/f64",
            "value": 0.00135404166666667,
            "unit": "s/batch",
            "extra": "MdAPE=0.026056946246855; batch=65536 pts/call"
          },
          {
            "name": "eval/3d/smooth/f64",
            "value": 0.00220173111111111,
            "unit": "s/batch",
            "extra": "MdAPE=0.00979284386389286; batch=65536 pts/call"
          },
          {
            "name": "eval/2d->3d/vector/f64",
            "value": 0.0011388755,
      ...
      },
      {
        ...
        "benches": [
          {
            "name": "eval/1d/runge/f64",
            "value": 0.000669406625,
            "unit": "s/batch",
            "extra": "MdAPE=0.00401695217589547; batch=65536 pts/call"
          },
          {
            "name": "eval/1d/runge-deep/f64",
            "value": 0.0010233229,
            "unit": "s/batch",
            "extra": "MdAPE=0.00376073609851781; batch=65536 pts/call"
          },
          {
            "name": "eval/1d/runge-deep/f32",
            "value": 0.000536557111111111,
            "unit": "s/batch",
            "extra": "MdAPE=0.0402793645008013; batch=65536 pts/call"
          },
          {
            "name": "eval/2d/bump/f64",
            "value": 0.0012175352,
            "unit": "s/batch",
            "extra": "MdAPE=0.00266168212805746; batch=65536 pts/call"
          },
          {
            "name": "eval/3d/smooth/f64",
            "value": 0.00214524366666667,
            "unit": "s/batch",
            "extra": "MdAPE=0.00166751304572379; batch=65536 pts/call"
          },
          {
            "name": "eval/2d/bump-deep/f64",
            "value": 0.0047215025,
            "unit": "s/batch",
            "extra": "MdAPE=0.0219154649746724; batch=65536 pts/call"
          },
          {
            "name": "eval/3d/smooth-deep/f64",
            "value": 0.044292879375,
            "unit": "s/batch",
            "extra": "MdAPE=0.000781627336358137; batch=65536 pts/call"
          },
          {
            "name": "eval/2d->3d/vector/f64",
            "value": 0.00111407588888889,
            "unit": "s/batch",
            "extra": "MdAPE=0.0024153404888277; batch=65536 pts/call"
          },
          {
            "name": "eval-scalar/1d/runge/f64",
            "value": 0.000290789444444444,
            "unit": "s/batch",
            "extra": "MdAPE=0.000777640232721087; batch=65536 pts/call"
          },
          {
            "name": "eval-scalar/1d/runge-deep/f64",
            "value": 0.000516493444444444,
            "unit": "s/batch",
            "extra": "MdAPE=0.00216432297157493; batch=65536 pts/call"
          },
          {
            "name": "eval-scalar/1d/runge-deep/f32",
            "value": 0.000444458,
      ...
      },
      {
        "commit": {
          ...
          "id": "806b0431137995e593f21352a83a7f1244dd4ef9",
          "message": "Build(deps): Bump the github-actions group with 2 updates (#37)\n\nBumps the github-actions group with 2 updates: [CodSpeedHQ/action](https://github.com/codspeedhq/action) and [pypa/cibuildwheel](https://github.com/pypa/cibuildwheel).\n\n\nUpdates `CodSpeedHQ/action` from 4.18.5 to 5.0.1\n- [Release notes](https://github.com/codspeedhq/action/releases)\n- [Changelog](https://github.com/CodSpeedHQ/action/blob/main/CHANGELOG.md)\n- [Commits](https://github.com/codspeedhq/action/compare/f99becdce5e5d51fd556489ebef684f4ecfd6286...88472375d0a4572cf70a9f1fe3a4e0ab8da1b924)\n\nUpdates `pypa/cibuildwheel` from 4.1.0 to 4.1.1\n- [Release notes](https://github.com/pypa/cibuildwheel/releases)\n- [Changelog](https://github.com/pypa/cibuildwheel/blob/main/docs/changelog.md)\n- [Commits](https://github.com/pypa/cibuildwheel/compare/294735312765b09d24a2fbec22660ce817587d55...4726cd35bb13f7bde50cf2761f2499ac7b3aa32c)\n\n---\nupdated-dependencies:\n- dependency-name: CodSpeedHQ/action\n  dependency-version: 5.0.1\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n  dependency-group: github-actions\n- dependency-name: pypa/cibuildwheel\n  dependency-version: 4.1.1\n  dependency-type: direct:production\n  update-type: version-update:semver-patch\n  dependency-group: github-actions\n...\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>",
          "timestamp": "2026-07-31T18:35:09Z",
          "url": "https://github.com/DiamonDinoia/treeweave/commit/806b0431137995e593f21352a83a7f1244dd4ef9"
        },
        "date": 1785750759262,
        "tool": "customSmallerIsBetter",
        "benches": [
          {
            "name": "eval/1d/runge/f64",
            "value": 0.000721142625,
            "unit": "s/batch",
            "extra": "MdAPE=0.00255317431691496; batch=65536 pts/call"
          },
          {
            "name": "eval/1d/runge-deep/f64",
            "value": 0.00126293455555556,
            "unit": "s/batch",
            "extra": "MdAPE=0.00560093984811083; batch=65536 pts/call"
          },
          {
            "name": "eval/1d/runge-deep/f32",
            "value": 0.000604626666666667,
            "unit": "s/batch",
            "extra": "MdAPE=0.00790691429066798; batch=65536 pts/call"
          },
          {
            "name": "eval/2d/bump/f64",
            "value": 0.00195588575,
            "unit": "s/batch",
            "extra": "MdAPE=0.00286963862345291; batch=65536 pts/call"
          },
          {
            "name": "eval/3d/smooth/f64",
            "value": 0.0028027955,
            "unit": "s/batch",
            "extra": "MdAPE=0.00266299247160871; batch=65536 pts/call"
          },
          {
            "name": "eval/2d/bump-deep/f64",
            "value": 0.006629559625,
            "unit": "s/batch",
            "extra": "MdAPE=0.00693855990930567; batch=65536 pts/call"
          },
          {
            "name": "eval/3d/smooth-deep/f64",
            "value": 0.047051429125,
            "unit": "s/batch",
            "extra": "MdAPE=0.00106687894061341; batch=65536 pts/call"
          },
          {
            "name": "eval/2d->3d/vector/f64",
            "value": 0.00169240977777778,
            "unit": "s/batch",
            "extra": "MdAPE=0.00301611484051979; batch=65536 pts/call"
          },
          {
            "name": "eval-scalar/1d/runge/f64",
            "value": 0.000293119,
            "unit": "s/batch",
            "extra": "MdAPE=0.00322460253564447; batch=65536 pts/call"
          },
          {
            "name": "eval-scalar/1d/runge-deep/f64",
            "value": 0.00058419075,
            "unit": "s/batch",
            "extra": "MdAPE=0.00226509221764703; batch=65536 pts/call"
          },
          {
            "name": "eval-scalar/1d/runge-deep/f32",
